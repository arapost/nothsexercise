...
- gradle v5.2.1
- java 8
- [AssertJ] (http://joel-costigliola.github.io/assertj/) which allows to write fluent assertions in tests
...
- The order that promotion rules are applied matters (changing the order will affect the result). 
   Here the assumption is that the discount on the total amount of the purchase should apply last   
